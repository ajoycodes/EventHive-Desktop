...
public class EventDAO {
    ...
    public boolean createEvent(Event event) {
        String sql = "INSERT INTO events (name, date_time, location, description, ticket_price, total_seats, available_seats, organizer_id, status) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)";
    ...
    public List<Event> getEventsByOrganizer(int organizerId) {
        List<Event> events = new ArrayList<>();
        String sql = "SELECT * FROM events WHERE organizer_id = ? ORDER BY date_time ASC";
    ...
    public boolean updateEvent(Event event) {
        String sql = "UPDATE events SET name = ?, date_time = ?, location = ?, description = ?, ticket_price = ?, total_seats = ?, available_seats = ?, status = ? WHERE id = ?";
    ...
    public List<Event> getEventsByStatus(String status) {
        List<Event> events = new ArrayList<>();
        String sql = "SELECT * FROM events WHERE status = ? ORDER BY date_time ASC";
    ...
    public List<Event> searchEventsByLocation(String location) {
        List<Event> events = new ArrayList<>();
        String sql = "SELECT * FROM events WHERE LOWER(location) LIKE ? AND status = 'ACTIVE' ORDER BY date_time ASC";
    ...
    public List<Event> getEventsByDateRange(LocalDateTime startDate, LocalDateTime endDate) {
        List<Event> events = new ArrayList<>();
        String sql = "SELECT * FROM events WHERE date_time >= ? AND date_time <= ? AND status = 'ACTIVE' ORDER BY date_time ASC";
